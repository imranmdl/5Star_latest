...
import { mountReviewPrompt } from './review-form.js';
...
async function renderList() {
  try {
    ...
    // Someone looking at a delivered order is the likeliest person to say
    // something about it. Not awaited: the orders list must not wait on it.
    mountReviewPrompt(root.querySelector('[data-review-prompt]'));
  } catch (error) {
    root.innerHTML = '';
    showError(error, root);
  }
